document.addEventListener("DOMContentLoaded", () => {
    ...
    // اگر دکمه در HTML وجود نداشت، خودکار ساخته می‌شود.
    if (!btn) {
    ...
    const calculatePerformance = () => {
        ...
        const positionBonus = {
            ST: attack, LW: attack, RW: attack,
            CAM: creation, CM: creation,
    ...
    const playMatch = () => {
        ...
        const assists = Math.min(remainingGoals, Math.random() < assistChance ? 1 : 0);
